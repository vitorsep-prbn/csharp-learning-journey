...
🎨 Cores no terminal
É um projeto simples e feito para aprendizado, mas representa um passo além dos exercícios individuais.
📈 Minha evolução
👋 Hello World
      ↓
📥 Entrada de dados
...
Execute
dotnet run
O Program.cs funciona como ponto de entrada.
Como os exercícios são independentes, normalmente apenas um deles é executado por vez.
📁 Estrutura
...
│
└── assets/
    └── csharp-learning-journey-hero.png
...
�
🟢 Um conceito por vez. Um projeto por vez. 🟡 

�
Feito por @vitorsep-prbn 💚 
